    ...
    return (
      <div className="space-y-4">
        ...
        <div className="bg-white rounded-2xl border border-border-light p-8 text-center shadow-card">
          ...
          <p className="text-sm text-gray-500">Connect Google Ads to see metrics here</p>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-white rounded-2xl border border-border-light p-5 shadow-card">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={googleDailyData}>
                ...
                />
                <Bar dataKey="spend" fill="#4285F4" radius={[4, 4, 0, 0]} name="spend" />
                <Bar dataKey="revenue" fill="#34A853" radius={[4, 4, 0, 0]} name="revenue" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        )}
